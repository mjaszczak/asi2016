...
class LaptopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laptop" do
    assert_difference('Laptop.count') do
      post laptops_url, params: { laptop: { brand: @laptop.brand, model: @laptop.model } }
    end

    assert_redirected_to laptop_path(Laptop.last)
  end
  ...
  test "should update laptop" do
    patch laptop_url(@laptop), params: { laptop: { brand: @laptop.brand, model: @laptop.model } }
    assert_redirected_to laptop_path(@laptop)
  end
